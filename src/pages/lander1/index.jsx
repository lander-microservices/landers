...
export default function Lander1({ number, init, callClickCb, voluumUrl }) {
  ...
  return (
    <>
    <div className="lander-hero-section">
      <div className="container">
        <div className="row">
          <div className="lander-hero-content col">
              <h1 className="heading">
                Up To <span className="span-1">$5,100/Year</span> Grocery + Rent Allowance Could be Yours with Incredible New Medicare Plan
              </h1>
    ...
    <div className="lander-content-section">
      <div className="container">
        <div className="row">
          <div className="lander-content col">
            ...
            <p>The <span className="span-2">Healthy Grocery Allowance,</span>{" "} recently approved for people with Medicare Advantage plans, could give you up to $5,100/year to spend on the foods you need.</p>
            ...
            <p className="child-para-span-3"> A Hotline opened to help Americans check if they qualify. The phone number is:{" "} <span className="span-3">(888) 305-2015.</span></p>
            <p>The average wait time to talk with one of our agents is about <span className="span-2"> 2-3 minutes,</span> so the Grocery Allowance benefit is getting a lot of people to call.</p>
            <p>When up to $5,100 per year is available, it makes sense that it's so popular. You could also qualify for free rides to doctor's appointments, drugstore allowances, free meal deliveries, and even more! Our free, private, and confidential hotline number is{" "} <span className="span-4">(888) 305-2015 </span>"Give us a call to see if you qualify!"</p>
          </div>
        </div>
      </div>
    </div>
    <div className="lander-cta-section">
      <div className="container">
        <div className="row">
          ...
          <div className="cta-button-list col">
              <a className="btn btn-blue-child">Below 64</a>
              <a className="btn btn-blue-child">65 - 70</a>
              <a className="btn btn-blue-child">71 - 75</a>
              <a className="btn btn-blue-child">76 - 80</a>
              <a className="btn btn-blue-child">81 - 85</a>
              <a className="btn btn-blue-child">86+</a>
          </div>
          <div className="cta-main-button col">
            <a href="#" className="btn main-btn"></a>
          </div>
        </div>
      </div>
    </div>
